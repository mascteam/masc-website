const AboutSection = () => {
  return (
    <section className="border-t h-[60vh] md:h-screen w-screen flex flex-col md:flex-row justify-around md:justify-around items-center px-5 md:px-20 uppercase">
      <div className="w-full md:w-1/2">
        ...
        <h1 className="cursor-target text-lg md:text-4xl md:max-w-lg">EXPLORING THE <br/> BEAUTY OF <br/> MATH AND SCIENCE</h1>
      </div>
      <div className="w-full md:w-1/2"> 
