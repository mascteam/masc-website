const AboutSection = () => {
  return (
    <section className="h-[70vh] border border-black md:h-screen w-screen flex flex-col md:flex-row justify-around md:justify-around items-center px-5 md:px-20 uppercase">
